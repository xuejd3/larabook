...
@section('content')
  <div class="text-center markdown-body py-32 text-gray-darkest">
    <svg t="1551339945997" height="100" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
         p-id="1617"
    ...
    <a href="{{ route('larabook.docs.index') }}">
      <button class="bg-blue hover:bg-blue-dark font-bold py-2 px-4 rounded">
        @lang('larabook::messages.back-to-homepage')
      </button>
    </a>
  </div>
@stop
