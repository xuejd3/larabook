<div class="relative">
  <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded-lg py-2 px-4 text-gray-800 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="search-input" type="text" placeholder="{{ config('larabook.plugins.docsearch.placeholder') ?? __('larabook::messages.search-the-docs') }}">
